...
const config = {
    ...
    walletName: `${process.env.USERNAME || 'kshitij'}_wallet`,
    ...
    userInformation: {
        name: process.env.NAME || 'Kshitij Garcia',
        email: process.env.EMAIL || 'kshitij@faber.edu',
        ...
        username: process.env.USERNAME || 'kshitij',
